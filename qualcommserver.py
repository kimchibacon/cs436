...
def main():
    ...
    #
    server.dns_table.touch_record( DnsRecord('www.qualcomm.com', 'A', '104.86.224.205', 0, 1) )
    server.dns_table.touch_record( DnsRecord('qtiack12.qti.qualcomm.com', 'A', '129.46.100.21', 0, 1) )
